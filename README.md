...
**Here's the magic:** the very first person to use a particular language + app version combination automatically contributes their translations back to this repository. Every user after them gets those translations instantly from our CDN — no on-device model download required.
...
- **Every user after that:** Instant translated docs, no model download needed
