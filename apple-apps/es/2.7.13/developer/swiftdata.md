...
|-------|--------|-----|
| `num` | `NodeInfoEntidad` | Busqué en cada paquete entrante |
| `num` | `Entidad de usuario` | Busqué cada mensaje |
| `Id de mensaje` | `Entidad de mensaje` | ACK búsquedas, deduplicación |
| `hwModelo` | `Entidad de hardware del dispositivo` | Buscaciones de imágenes de hardware |
...
| Tipo | Descripción |
|------|-------------|
| `NodeInfoEntidad` | Un nodo escuchado en la malla |
| `Entidad de mensaje` | Un canal o mensaje directo |
| `Entidad de posición` | Una actualización de la posición del GPS |
| `Entidad de Telemetría` | Datos del sensor del dispositivo/ambiente |
...
|-------------|-----|-----------|
| `NodeInfoEntity.posiciones` | 5 000 | Las posiciones más antiguas eliminadas cuando se superan |
| `NodeInfoEntity.telemetrías` | 5 000 por tipo de métricas | La telemetría más antigua de ese tipo eliminada |
