...
La aplicación incluye un navegador de Ayuda y Documentación integrado, un sitio Jekyll en GitHub Pages, y la documentación también se publica en el sitio principal [meshtastic.org](https://meshtastic.org).
