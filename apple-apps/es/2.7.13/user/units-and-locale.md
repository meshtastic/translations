...
> **Tip — No es necesario cambiar de unidad**
> Cambie las preferencias de medición de su sistema y cada pantalla en Meshtastic se actualiza automáticamente: detalles de nodos, gráficos de telemetría, clima, altitud y más.
...
> **Tip — Reino Unido vs. Imperial de EE. UU.**
> El sistema de medición del Reino Unido utiliza millas para la distancia, pero piedras para el peso corporal y Celsius para la temperatura. El sistema estadounidense utiliza Fahrenheit y libras. La aplicación respeta estas distinciones automáticamente.
