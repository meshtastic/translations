...
| Tema raíz | El prefijo del tema para todos los mensajes publicados (por defecto:`msh`). |
...
| JSON habilitado | Eliminado. El soporte de paquetes JSON fue obsoleto y eliminado en el firmware. |
