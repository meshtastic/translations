...
- IPhone con iOS 17.5 o posterior
...
> **Tip —** Para obtener detalles de implementación y arquitectura de componentes, consulte la [Guía para desarrolladores de CarPlay](../developer/carplay.md).
