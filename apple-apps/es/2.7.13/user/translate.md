...
4. Sus traducciones se cargan de forma anónima en el repositorio [meshtastic/translations](https://github.com/meshtastic/translations).
...
Todas las traducciones en el dispositivo se cargan en el repositorio [meshtastic/translations](https://github.com/meshtastic/translations). Son un gran punto de partida, ¡pero las traducciones automáticas no son perfectas! Si eres un hablante nativo y detectas algo que podría mejorarse:

1. Navegue hasta su idioma + versión de la aplicación en [apple-apps/](https://github.com/meshtastic/translations/tree/main/apple-apps)
...
- **[Local-localizer](https://github.com/JoshuaSullivan/local-localizer)** instalado (ver más abajo)
