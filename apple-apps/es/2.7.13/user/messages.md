...
|--------|-------|-----------------|
| Símbolo SF en negrita | Atrevido | `**text**` |
| Símbolo SF en cursiva | Cursiva | `*text*` |
| Símbolo de SF tachado | Tachado | `~~text~~` |
| Símbolo de código SF | Codificación | `` `text` `` |
...
| ![Mixed preview](../assets/screenshots/messagePreview_mixed.png) | Vista previa que muestra **negrita**, *cursiva*, ~~strikethrough~~, y`code`Formato combinado. |
