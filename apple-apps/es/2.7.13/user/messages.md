...
Meshtastic utiliza un sistema de canales para transmisiones grupales y mensajes directos para conversaciones privadas de un a uno.

## canal

### Historial de mensajes

Por defecto, las conversaciones de los canales cargan los **50 mensajes** más recientes. Desplázate hacia arriba y toca **Cargar más** para obtener el siguiente lote. Esto mantiene la aplicación responsive en canales con miles de mensajes.

### Índice de canales

| representación | significado |
|--------|---------|
| **0** (círculo primario) | Canal principal: aquí se envían los paquetes de transmisión. Los datos de ubicación se transmiten desde el primer canal donde está habilitado (firmware 2.7+). |
...
El formulario del canal le permite configurar el nombre del canal, la clave de encriptación, el rol, el intercambio de posiciones y la configuración de la subida/baja de MQTT.

### Seguridad del canal

| icono | significado |
|------|---------|
| ![Securely Encrypted](../assets/screenshots/lockClosed.png) | **Cifrado seguro**: el canal utiliza una clave AES de 128 bits o 256 bits. |
| ![Not Securely Encrypted](../assets/screenshots/lockOpen.png) | **No cifrado de forma segura**: el canal no utiliza ninguna clave ni una clave conocida de 1 byte, pero no se utiliza para datos de ubicación precisos. |
