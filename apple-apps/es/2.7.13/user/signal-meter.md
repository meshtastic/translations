...
Piensa en ello como escuchar a un amigo hablar: **RSSI** es lo fuerte que es su voz, **el ruido del piso** es el ruido de fondo en la habitación, y **SNR** es lo fácil que puedes distinguir su voz de ese ruido.
...
|-------|------|----------|---------|
| El bien | 3 | RSSI mejor que`-115 dBm`**Y** SNR por encima del límite de referencia para su preajuste | La señal es fuerte y clara, conexión saludable. |
...
| Malo | 1 | RSSI cae a`-120 dBm`O peor, **O** SNR dentro de`5.5 dB`Del punto de ruptura absoluto de tu preajuste | Apenas colgando, en el borde del rango o interferencia fuerte. |
...
> **Tip — No se asuste por el bajo RSSI:**Podrías ver un valor RSSI aparentemente terrible como`-118 dBm`. En un teléfono móvil, tendrías cero barras. Pero si tienes un SNR de`+2 dB`, ¡Meshtastic seguirá mostrando una señal fuerte! *La biblioteca está en silencio, por lo que el susurro se escucha perfectamente. *

> **Warning — Cuidado con el ruido local:**Si conectas una antena enorme y ves un gran RSSI (por ejemplo,`-90 dBm`) Pero su medidor de señal solo muestra **1 Bar (Malo)**, tiene un problema. Significa que tiene una interferencia local, tal vez una fuente de alimentación barata, una computadora ruidosa o una torre de radio cercana, que crea tanta estática que está ahogando su malla.
