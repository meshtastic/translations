...
| Intervalo de calidad del aire | ¿Con qué frecuencia se transmiten los datos del sensor de calidad del aire? |
...
La disponibilidad del sensor depende de su hardware. Consulte la [Guía de hardware de Meshtastic](https://meshtastic.org/docs/hardware/) para la compatibilidad.
