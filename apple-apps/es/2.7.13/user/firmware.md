...
- Si la radio aparece bloqueada después de una actualización fallida, generalmente se puede recuperar usando el [Meshtastic Flasher](https://flasher.meshtastic.org/) en un ordenador.
...
- Algunas radios más antiguas no admiten actualizaciones OTA. Consulte la [lista de compatibilidad de hardware](https://meshtastic.org/docs/hardware/).
