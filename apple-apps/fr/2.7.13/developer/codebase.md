...
Les vues qui ont besoin de connectivité injectent`@EnvironmentObject var accessoryManager: AccessoryManager`. Les vues qui ont besoin d'une navigation injectent`@EnvironmentObject var router: Router`.
