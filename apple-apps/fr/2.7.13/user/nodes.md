...
| ![](../assets/screenshots/roleRouter.png) | Router | Noeud d'infrastructure dédié - rediffuse toujours les paquets une fois. Mieux positionné dans des endroits stratégiques pour maximiser la couverture. |
...
## Exemples de ligne de nœuds complets
