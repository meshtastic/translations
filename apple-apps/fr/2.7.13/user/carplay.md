...
- IPhone exécutant iOS 18 ou version ultérieure
...
> **Tip —**Pour plus de détails sur la mise en œuvre et l'architecture des composants, consultez le [Guide du développeur CarPlay](../developer/carplay.md).
