...
> **Tip — Vous n'avez jamais besoin de basculer les unités dans l'application. ** Modifiez les préférences de mesure de votre système et chaque écran de Meshtastic se met automatiquement à jour - détails des nœuds, tableaux de télémétrie, météo, altitude, et plus encore.
...
> **Tip — Royaume-Uni contre Impérial américain. ** Le système de mesure britannique utilise des miles pour la distance, mais des pierres pour le poids corporel et Celsius pour la température. Le système américain utilise Fahrenheit et livres. L'application respecte automatiquement ces distinctions.
