...
|--------|-------|-----------------|
| Symbole SF en gras | Gras | `**text**` |
| Symbole SF en italique | Italique | `*text*` |
| Symbole SF barré | Barré | `~~text~~` |
| Code Symbole SF | Code | `` `text` `` |
...
| ![Mixed preview](../assets/screenshots/messagePreview_mixed.png) | Aperçu montrant **gras**, *italique*, ~~strikethrough~~, et`code`Formatage combiné. |
