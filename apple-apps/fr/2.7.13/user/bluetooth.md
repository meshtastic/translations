...
1. Allumez votre radio Meshtastic.2. Ouvrez l'application et appuyez sur l'onglet **Connect**.3. L'application recherche automatiquement les appareils à proximité lorsque vous n'êtes pas connecté.4. Appuyez sur le nom de votre appareil dans la liste pour vous connecter.
...
## Dépannage
**Radio n'apparaît pas dans la liste**- Assurez-vous que le Bluetooth est activé dans les paramètres iOS → Bluetooth.- Déplacez-vous à moins de 10 mètres de la radio.- Redémarrez la radio.
**Connexion tombe à plusieurs reprises**- Vérifiez le niveau de la batterie sur la radio.- Essayez d'oublier l'appareil dans les paramètres iOS → Bluetooth et se reconnecter.
**L'application demande l'autorisation Bluetooth**- Accordez l'autorisation dans les paramètres iOS → Confidentialité et sécurité → Bluetooth → Meshtastic.
---
> **Conseil — Radio connectée**> Balayez vers la gauche pour vous déconnecter. Appuyez longuement pour démarrer l'activité en direct.
