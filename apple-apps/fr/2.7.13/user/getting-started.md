...
- Un appareil radio Meshtastic LoRa pris en charge (voir [meshtastic.org](https://meshtastic.org/docs/hardware/))
- IPhone, iPad ou Mac avec l'application Meshtastic installée
- Bluetooth activé sur votre appareil

## Étape 1 : Mettez votre radio sous tension
