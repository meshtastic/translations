...
1. Verbinden du sich mit deinem Radio.
2. Gehen du zu **Einstellungen → Firmware-Updates**.
...
1. Tippen du auf **Firmware aktualisieren**, wenn eine neuere Version verfügbar ist.
...
Wählen du den Aktualisierungskanal unter **Einstellungen → Firmware-Updates** aus.

## Vermittlung

**Update schlägt auf halbem Weg fehl**
- Halten du das Radio während des Updates innerhalb von 1–2 Metern von deinem Telefon.
...
- Einige ältere Radios unterstützen keine OTA-Updates. Überprüfen du die [Hardware-Kompatibilitätsliste](https://meshtastic.org/docs/hardware/).

**Version wird als unbekannt angezeigt**
- Stellen du sicher, dass das Radio vollständig angeschlossen und synchronisiert ist (es dauert normalerweise 5-10 Sekunden, nachdem die BLE-Verbindung hergestellt wurde).
