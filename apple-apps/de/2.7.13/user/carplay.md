...
Verwende diese Siri-Sprachbefehle in CarPlay, um mit Meshtastic zu interagieren:

| Sprachbefehl | Beispielsatz | Beschreibung |
|---|---|---|
| Nachricht senden | "Sende eine Nachricht auf Meshtastic" | Verfasst und sendet eine Textnachricht an einen Kontakt oder Kanal |
