...
## Anforderungen
- IPhone mit iOS 18 oder neuer- Eine unterstützte CarPlay-Kopfeinheit oder der CarPlay-Simulator in Xcode- Ein Meshtastic-Gerät, das über Bluetooth, TCP oder seriell verbunden ist- Siri aktiviert - die App fordert Siri-Autorisierung während des Onboardings und erneut bei nachfolgenden Starts an
## Schnittstelle
