...
Verwenden du diese Siri-Sprachbefehle in CarPlay, um mit Meshtastic zu interagieren:

| Sprachbefehl | Beispielsatz | Beschreibung |
|---|---|---|
| Nachricht senden | "Senden du eine Nachricht auf Meshtastic" | Verfasst und sendet eine Textnachricht an einen Kontakt oder Kanal |
...
> **Tip —** Einzelheiten zur Implementierung und zur Komponentenarchitektur finden du im [CarPlay-Entwicklerhandbuch](../developer/carplay.md).
