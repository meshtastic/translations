...
Gehen du zu **Einstellungen → MQTT**:
...
| Aktiviert | Schalten du die MQTT-Brückung ein/aus. |
...
| TLS aktiviert | Verwenden du TLS für die MQTT-Verbindung. Erfordert einen Broker mit TLS-Unterstützung. |
...
- Verwenden du immer **Verschlüsselung aktiviert** in der Produktion, um den Inhalt der Nachricht zu schützen.
- Erwägen du, einen privaten Makler anstelle des öffentlichen zu verwenden`mqtt.meshtastic.org`.

## Öffentlicher Makler

Der öffentliche MQTT-Broker bei`mqtt.meshtastic.org`Steht zum Testen zur Verfügung. **Übermitteln du keine sensiblen Informationen über den öffentlichen Makler. ** Verwenden du es nur für die erste Einrichtungsprüfung.
