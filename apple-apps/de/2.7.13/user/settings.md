...
|---------|-------------|
| Region | Ihre geografische Region. **Muss korrekt eingestellt sein** - die Verwendung der falschen Region ist illegal und verhindert die Kommunikation mit lokalen Knoten. Zu den verfügbaren Regionen gehören der Standardsatz plus Nepal 865MHz, Brasilien 902MHz, ITU Region 1 Amateur 2m, ITU Region 2/3 Amateur 2m und die EU 866 / 874 / 917 / 868-enge Bänder. |
...
- **Spracherkennung**: Die App liest jedes Mal, wenn Sie eine Dokumentationsseite öffnen, die primäre Spracheinstellung Ihres Geräts.
...
> **Tip — Sprachwechsel**: Wenn Sie die Sprache Ihres Geräts ändern, während die App geöffnet ist, werden die Dokumentationsseiten automatisch in der neuen Sprache neu geladen.
