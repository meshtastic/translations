...
1. Drücken du lange auf eine beliebige Stelle auf der Karte.
2. Geben du einen Namen, eine optionale Beschreibung und ein Schlosssymbol ein (um die Bearbeitung auf den Ersteller zu beschränken).
3. Tippen du auf **Speichern** – der Wegpunkt sendet an alle Knoten auf dem primären Kanal.

### Bearbeiten eines Wegpunkts

Tippen du auf einen vorhandenen Wegpunktstift und dann auf **Bearbeiten**. Ändert die Übertragung auf das Netz sofort.

### Löschen eines Wegpunkts

Tippen du auf den Wegpunkt und dann auf **Löschen**. Die Löschung sendet an alle Knoten.
...
deine aktuelle GPS-Position wird als blauer Punkt (Standard-iOS-Standortanzeige) angezeigt. Aktivieren du die Positionsübertragung in **Einstellungen → Position**, um deinen Standort mit dem Netz zu teilen.
