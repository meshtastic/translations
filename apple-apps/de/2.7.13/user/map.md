...
1. Drücken Sie lange auf eine beliebige Stelle auf der Karte.2. Geben Sie einen Namen, eine optionale Beschreibung und ein Schlosssymbol ein (um die Bearbeitung auf den Ersteller zu beschränken).3. Tippen Sie auf **Speichern** – der Wegpunkt sendet an alle Knoten auf dem primären Kanal.
