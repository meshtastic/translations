...
Local Mesh Discovery durchsucht deinen Bereich, um Meshtastic-Funkgeräte in der Nähe zu finden, die mit verschiedenen Frequenzeinstellungen arbeiten. Verwende es, um zu ermitteln, welche LoRa-Konfiguration an deinem Standort am aktivsten ist, bevor du einen neuen Knoten einrichten.
...
1. Gehe zu **Einstellungen → Lokale Mesh-Entdeckung**.
2. Tippe auf **Scan starten**.
3. Der Scanner wechselt automatisch durch die Einstellungen. Jeder Zyklus dauert einige Minuten – schließe die App nicht während eines Scans.
...
Tippe auf eine Ergebniszeile und dann auf **Einstellung anwenden**, um dein angeschlossenes Radio so zu konfigurieren, dass es der aktivsten Einstellung in deinem Bereich entspricht. Dadurch wird die LoRa-Konfiguration direkt im Radio aktualisiert.
