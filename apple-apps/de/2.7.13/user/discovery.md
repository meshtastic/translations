...
1. Gehen Sie zu **Einstellungen → Lokale Mesh-Entdeckung**.
2. Tippen Sie auf **Scan starten**.
3. Der Scanner wechselt automatisch durch die Einstellungen. Jeder Zyklus dauert einige Minuten – schließen Sie die App nicht während eines Scans.
