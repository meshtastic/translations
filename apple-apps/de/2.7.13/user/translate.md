...
2. Textsegmente werden mit dem Übersetzungs-Framework von Apple übersetzt. Wenn das Übersetzungs-Framework Ihre Sprache nicht unterstützt, greift die App auf FoundationModels auf dem Gerät zurück.
...
1. Gabeln Sie das [Meshtastic-Apple-Repository](https://github.com/meshtastic/Meshtastic-Apple/tree/main) in Ihr GitHub-Konto.
2. Klonen Sie das Projekt und öffnen Sie`Meshtastic.xcworkspace`In Xcode.
3. Wählen Sie die`Localizable.xcstrings`Datei im Projektnavigator.
4. Befolgen Sie die [Schritte zum Hinzufügen oder Aktualisieren von Übersetzungen](https://developer.apple.com/documentation/xcode/localizing-and-varying-text-with-a-string-catalog) in der Apple-Dokumentation.
5. Erstellen Sie einen Pull-Request für das Projekt mit Ihren Änderungen.
