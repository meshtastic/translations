...
| `SerialTransport.swift` | IOKit-Serie | Nur macOS; USB-Serienadapter |
...
| `+TAK` | `handleATAKPluginPacket(_:)`,`handleATAKPluginV2Packet(_:)`,`handleATAKForwarderPacket(_:)`,`sendTAKPacket(_:channel:)`,`sendTAKV2Packet(_:channel:)`,`sendCoTToMeshV2(_:channel:)`. Siehe [TAK-Protokoll](tak-protocol.html) für Details zum V1/V2-Drahtformat. |
