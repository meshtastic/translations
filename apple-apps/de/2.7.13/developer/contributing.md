...
| Tiefe Verbindung | [`meshtastic:///settings/helpDocs`](meshtastic:///Einstellungen/helpDocs) |
...
-`guard`Für einen frühen Ausgang; vermeiden Sie tief verschachtelte`if`.
...
3. Erstellen und verifizieren Sie, ob Tests bestanden werden.
