...
Befolgen du das gleiche Muster, wenn du neue Subsysteme zu`AccessoryManager`Oder andere große Klassen.
...
Ansichten, die Konnektivität benötigen, injizieren`@EnvironmentObject var accessoryManager: AccessoryManager`. Ansichten, die eine Navigation benötigen`@EnvironmentObject var router: Router`.
