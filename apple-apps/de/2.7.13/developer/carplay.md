...
1. Erstelle einen Handler in`Meshtastic/Intents/`Anpassung an die entsprechenden`INIntent`Protokoll.
...
4. Füge eine Nutzungsbeschreibung in`Info.plist`Wenn die Absicht eine neue Datenschutzberechtigung erfordert.
