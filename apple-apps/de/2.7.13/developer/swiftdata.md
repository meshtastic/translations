...
2. Anhinden`MeshtasticSchemaV2.self`Zu`MeshtasticMigrationPlan.schemas`(Neuest zuletzt).3. Fügen Sie eine Migrationsstufe hinzu`MeshtasticMigrationPlan.stages`:
```swift
